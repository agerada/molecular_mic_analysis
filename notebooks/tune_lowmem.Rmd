...
if (!interactive) {
  option_list <- list(
    ...
    make_option(c("-f", "--folds"), type = "double", default = 3,
                help = "Number of folds for cross-validation
                or train ratio for train-test split [default = 3]"),
...
write_rds(folds_tune, paste0(prefix, "folds_tune.rds"))
```
...
for (i in seq_along(all_abx)) {
  ...
  write_rds(step1_tune_kmer, paste0(prefix, "step1_tune_kmer.rds"))
  ...
  write_rds(step2_tune_kmer, paste0(prefix, "step2_tune_kmer.rds"))
}
```
...
for (i in seq_along(all_abx)) {
  ...
  write_rds(step1_tune_annots, paste0(prefix, "step1_tune_annots.rds"))
  ...
  write_rds(step2_tune_annots, paste0(prefix, "step2_tune_annots.rds"))
}
```
