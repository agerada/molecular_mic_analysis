...
db_path <- "../data/meta_data_bv_brc_format.txt"
kmers_dir <- "../data/kmers/"
kmer <- 3
antibiotics <- "CIP"
output <- getwd()
seed <- 42
...
eta <- 2 / 1000
early_stop <- 10
pre_fold_info <- "~/Library/CloudStorage/OneDrive-TheUniversityofLiverpool/Data/molecularMIC_paper/data/multi_flat/10/CIP_folds_tune_genome_names.rds"
```
